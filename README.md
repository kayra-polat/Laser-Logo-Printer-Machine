...
## Quick Overview
- The program is a console application written using [Javascript](https://www.javascript.com/) that can engrave shapes on an 11x11 grid and compare these shapes. Today, this system is also a part of the 3D printer. Node.js environment is needed for the program to run.
